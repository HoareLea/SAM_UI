    ...
    public static partial class Modify
    {
        public static void SolarSimulation(this UIAnalyticalModel uIAnalyticalModel, IWin32Window owner = null)
        {
            ...
            Action action = new Action(() => 
            {
                ...
                SolarCalculator.Modify.Simulate(analyticalModel, hoursOfYear.ConvertAll(x => new DateTime(2018, 1, 1).AddHours(x)), false, Core.Tolerance.Angle, Core.Tolerance.MacroDistance, Core.Tolerance.MacroDistance, 0.012, Core.Tolerance.Distance);
