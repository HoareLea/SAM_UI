...
namespace SAM.Core.Mollier.UI.Grasshopper
{
    public class SAMMollierCreateAdiabaticHumidificationProcessByRelativeHumidity : MollierDiagramComponent
    {
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            AdiabaticHumidificationProcess adiabaticHumidificationProcess = Core.Mollier.Create.AdiabaticHumidificationProcess_ByRelativeHumidity(start, relativeHumidity, efficiency);
