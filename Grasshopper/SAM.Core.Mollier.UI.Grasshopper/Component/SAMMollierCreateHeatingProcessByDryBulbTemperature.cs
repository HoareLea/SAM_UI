...
{
    public class SAMMollierCreateHeatingProcessByDryBulbTemperature : MollierDiagramComponent
    {
        /// <summary>
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            HeatingProcess heatingProcess = Core.Mollier.Create.HeatingProcess(mollierPoint, dryBulbTemperature, efficiency);
