    ...
    public partial class BatchCreateViewsControl : UserControl
    {
        ...
        private List<AnalyticalTwoDimensionalViewSettings> GetAnalyticalTwoDimensionalViewSettingsList()
        {
            ...
            foreach (Level level in levels)
            {
                ...
                AnalyticalTwoDimensionalViewSettings analyticalTwoDimensionalViewSettings = new AnalyticalTwoDimensionalViewSettings(Guid.NewGuid(), name, Geometry.Spatial.Create.Plane(elevation), null, types);
